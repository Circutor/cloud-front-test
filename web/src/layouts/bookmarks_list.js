...
import { Layout, Menu, Table, Typography, Space } from 'antd';
      ...
      render: (_, record) => (
        <Space size='middle'>
          <Button
            ...
            onClick={() => navigate(`/buildings/${record.BuildingId}`)}
          />
        </Space>
      ),
      align: 'center',
    ...
    <Layout className='layout' style={{ minHeight: '100vh' }}>
      <Header>
        ...
        <Menu
          ...
          style={{ float: 'right' }}
        >
          <Menu.Item key='all' onClick={() => navigate('/buildings')}>
            All
          </Menu.Item>
          <Menu.Item key='bookmarks' onClick={() => navigate('/bookmarks')}>
            Bookmarks
          </Menu.Item>
        </Menu>
        <Button
